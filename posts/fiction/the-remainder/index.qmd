...
/* Side gutters: warm ochre yellow on the left, deep slate-blue on the right,
   framing a cream reading column in the center. Gutters collapse on mobile. */
.fiction-page {
  background: #f4f1e8;
  color: #111;
...
.fiction-page::before {
  left: 0;
  background:
    linear-gradient(90deg, rgba(0,0,0,0.06), rgba(0,0,0,0) 40%),
    #e6c368; /* warm ochre / butter yellow */
  box-shadow: inset -1px 0 0 rgba(0,0,0,0.08);
}
.fiction-page::after {
  right: 0;
  background:
    linear-gradient(270deg, rgba(0,0,0,0.06), rgba(0,0,0,0) 40%),
    #e6c368; /* same warm ochre on the right */
  box-shadow: inset 1px 0 0 rgba(0,0,0,0.08);
}
@media (max-width: 1100px) {
  .fiction-page::before,
  .fiction-page::after { width: 28px; min-width: 28px; }
}
@media (max-width: 720px) {
  .fiction-page::before,
  .fiction-page::after { display: none; }
}
