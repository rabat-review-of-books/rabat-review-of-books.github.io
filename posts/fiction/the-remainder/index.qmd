---
pagetitle: "The Remainder · Rabat Review of Books"
title: "The Remainder"
subtitle: "A hammal carries a charred fragment across a silenced world, toward an archive that has been waiting a hundred and sixty years."
description: "A story in five parts. The baqiya — the remainder — is what compression cannot take."
author: "Mehdi Khribch"
date: "2026-04-14"
categories: [Fiction, Short Story]
image: https://picsum.photos/seed/rrb-escorial-library/1200/800
image-alt: "The Royal Library at El Escorial"
...
/* ---------- HERO: two-column title + illustration ---------- */
.fiction-hero {
  display: grid;
...
@media (max-width: 900px) {
  .fiction-hero { grid-template-columns: 1fr; padding: 2rem 1rem; min-height: auto; gap: 1.5rem; }
}
...
.fiction-body p.body-p {
  margin: 0 0 1.25rem 0;
  text-align: left;
  hyphens: auto;
}
.fiction-body p.first-p {
  margin-top: 0;
}
...
.section-break span { display: inline-block; padding-left: 1em; }
...
.fiction-figure-narrow { max-width: 520px; }
.fiction-figure-narrow img { aspect-ratio: 4 / 5; object-fit: cover; }
...
/* Dialog styling: keep default paragraph flow, curly quotes as-is */
.fiction-body p.body-p em { font-style: italic; }

/* Hide Quarto breadcrumbs/title block if it leaks */
...
<div class="fiction-hero">
  ...
  <div class="fiction-hero-art">
    <img src="https://picsum.photos/seed/rrb-escorial-library/1200/1200" alt="The Royal Library at El Escorial." loading="lazy"/>
  </div>
</div>
...
<div class="epigraphs">
  <blockquote class="epigraph"><p>Averroes, who knew neither Syriac nor Greek, was working from a translation of a translation.</p><cite>— Jorge Luis Borges, “Averroes’s Search”</cite></blockquote>
  <blockquote class="epigraph"><p>Every language leaks. The more you compress, the more it leaks. They took everything and got nothing but the leak.</p><cite>— Oulimata Diallo, field notes, Year 3 N.M.</cite></blockquote>
</div>
...
<figure class="fiction-figure">
  <img src="https://picsum.photos/seed/rrb-fez-medina-door/1200/800" alt="A door in the old medina of Fez." loading="lazy"/>
  <figcaption>A door in the old medina of Fez, where the story begins.</figcaption>
</figure>
...
<figure class="fiction-figure">
  <img src="https://picsum.photos/seed/rrb-timbuktu-ms/1200/800" alt="A page from the Timbuktu manuscripts." loading="lazy"/>
  <figcaption>A page from the Timbuktu manuscripts, carried through centuries by the families who kept them.</figcaption>
</figure>
...
<figure class="fiction-figure">
  <img src="https://picsum.photos/seed/rrb-atlas-tifinagh/1200/800" alt="Tifinagh inscription on stone in the Atlas mountains." loading="lazy"/>
  <figcaption>The sign of the free people: Tifinagh on stone in the High Atlas.</figcaption>
</figure>
...
<figure class="fiction-figure">
  <img src="https://picsum.photos/seed/rrb-escorial-granite/1200/800" alt="Interior of the Royal Library at El Escorial." loading="lazy"/>
  <figcaption>The barrel-vaulted library at El Escorial, built by Philip II to house an idea of empire.</figcaption>
</figure>
...
<figure class="fiction-figure fiction-figure-narrow">
  <img src="https://picsum.photos/seed/rrb-borges/900/1100" alt="Jorge Luis Borges." loading="lazy"/>
  <figcaption>Jorge Luis Borges, whose <em>Averroes’s Search</em> shadows this story.</figcaption>
</figure>
</div>

<div class="fiction-bio">
  <p><strong>El Mahdi Khribch</strong> is the founding editor of the <em>Rabat Review of Books</em>. "The Remainder" is his first published work of fiction.</p>
</div>
